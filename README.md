...
At this stage we obtained multiple g.vcf file that we will use for mutations identification with our SnpEff database after filtering. So, the analysis is not finished and needs for the continuation. 
